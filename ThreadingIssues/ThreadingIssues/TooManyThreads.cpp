...
//static const int numThreads = 2000;
//
...
//	}
//
//	std::chrono::time_point<std::chrono::system_clock> begin = starts[0];
//	std::chrono::time_point<std::chrono::system_clock> finalEnd = ends[0];
...
//	std::chrono::duration<double, std::milli> totalTime = finalEnd - begin;
//	/*for (int i = 0; i < numThreads; i++)
//	{
